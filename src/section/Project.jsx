  ...
  return (
    <section id="project" className="py-12 sm:px-4 lg:h-[90vh] sm:px-6 md:px-16 lg:px-24 bg-gray-700 text-white">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center space-y-8 md:space-y-0 md:space-x-8">
        ...
        <div className="project-item w-full shadow-xl shadow-yellow-500/50  md:w-1/3 bg-gray-900 rounded-lg shadow-lg p-11">
        ...
        <div className="project-item shadow-xl shadow-yellow-500/50 w-full md:w-1/3 bg-gray-900 rounded-lg shadow-lg p-9">
          <h3 className="text-xl font-semibold text-yellow-600 mb-4 text-center">
            Portfolio
          </h3>
          <p className="text-sm  text-center text-gray-400 mb-6">
        ...
        <div className="project-item shadow-xl shadow-yellow-500/50 w-full md:w-1/3 bg-gray-900 rounded-lg shadow-lg p-16">
          <h3 className="text-xl font-semibold text-yellow-600 mb-4 text-center">
            Bookmark
          </h3>
          <p className="text-sm  text-center text-gray-400 mb-6">
