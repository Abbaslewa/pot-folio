...
const ContactMe = () => {
  return (
    <div id="contact" className="relative min-h-screen flex flex-col sm:flex-row justify-center items-center bg-gray-700 overflow-hidden py-6 sm:py-0">
      <div className="relative w-full sm:w-1/2 h-full flex flex-col justify-center items-center space-y-3">
      ...
      <div className="relative z-10 w-full sm:w-1/2 flex justify-center items-center">
        <form className="flex flex-col space-y-4 w-[80%] sm:w-[65%] lg:w-[70%] p-6 sm:p-8 rounded-2xl shadow-lg transition-shadow duration-500 ease-in-out">
          ...
          <input
            ...
            className="p-2 sm:p-3 rounded-lg outline-none focus:ring-4 focus:ring-green-500 border-[1px] border-gray-600 bg-white/20 text-white placeholder-gray-300 transition-all duration-300 ease-in-out"
          />
          <input
            type="email"
            name="email"
          ...
          <textarea
            name="message"
            placeholder="Message"
            className="p-2 sm:p-3 h-24 sm:h-28 rounded-lg outline-none focus:ring-4 focus:ring-green-500 border-[1px] border-gray-600 bg-white/20 text-white placeholder-gray-300 transition-all duration-300 ease-in-out"
          ></textarea>

          <button type="submit" className="bg-gradient-to-r from-yellow-600 to-red-700 text-white p-2 sm:p-3 rounded-lg w-full text-sm sm:text-md font-semibold hover:from-yellow-700 hover:to-yellow-600 transition-colors duration-300 ease-in-out focus:ring-4 focus:ring-green-600 shadow-lg hover:shadow-xl hover:shadow-yellow-500/50">
            Submit
          </button>
        </form>
      </div>
